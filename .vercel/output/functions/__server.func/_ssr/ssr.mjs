...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DAKKSqDh.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BAnSfLYa.mjs").then((n) => n.t),
		import("./start-D8fUZ2kv.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createMiddleware as n, ssr_exports as r, createCsrfMiddleware as t };
